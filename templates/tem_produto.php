...
if (isset($queries) && isset($queries['pagina'])) {
    if ($queries['pagina'] === 'listagem') {
        ...
        echo '<form method="post" action="?pagina=cadastro"> <div id="mainDivCadastro"> 
                        ...
                        <br/> <br/>
                        <input type="number" placeholder="ValorProduto" value="valorProduto" class="form-control"/>
                        <br/> <br/>
                        <input type="number" placeholder="QuantidadeProduto" value="quantidadeProduto" class="form-control"/>
                        <br/> <br/>
